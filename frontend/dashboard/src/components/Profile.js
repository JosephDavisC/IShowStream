...
function Profile() {
    ...
    // Load monitoring status on mount
    useEffect(() => {
    ...
    const handleToggleMonitoring = async () => {
        ...
        try {
            const result = monitoringEnabled
            ...
            if (result.success) {
                ...
                setSuccess(
                    monitoringEnabled
                        ? "Monitoring paused. API credits saved! 💰"
                        : "Monitoring resumed. Chat ingestion active! 🚀"
                );
                setTimeout(() => setSuccess(""), 3000);
            } else {
    ...
    return (
        <div className="profile-page">
            <div className="profile-container">
                    ...
                    <form onSubmit={handleSubmit} className="profile-form">
                        <div className="form-group">
                            ...
                            <p className="form-help">
                                Enter the Twitch channel name you want to
                                analyze (without the URL)
                            </p>
                        </div>
                ...
                <div className="profile-section">
                    <h2 className="section-header">⚡ Monitoring Control</h2>
                    <div className="monitoring-control">
                        <div className="monitoring-info">
                            ...
                            <p>
                                {monitoringEnabled
                                    ? "Chat messages are being ingested and analyzed. API credits are being used."
                                    : "Chat ingestion is paused. No API credits are being consumed. The service will auto-scale to 0 after 15 minutes of inactivity."}
                            </p>
                        </div>
                        <button
                            onClick={handleToggleMonitoring}
                            className={`btn-toggle ${
                                monitoringEnabled ? "btn-pause" : "btn-resume"
                            }`}
                    ...
                    <div className="monitoring-tips">
                        <h4>💡 Tips to Save API Credits:</h4>
                        <ul>
                            <li>
                                <strong>Pause when not needed:</strong> Use the
                                pause button when you're not actively monitoring
                                chat
                            </li>
                            <li>
                                <strong>Auto-scaling:</strong> Services
                                automatically scale to 0 after 15 minutes of
                                inactivity (saves compute costs)
                            </li>
                            <li>
                                <strong>Resume anytime:</strong> Click resume to
                                start monitoring again (takes ~5-10 seconds to
                                restart)
                            </li>
                        </ul>
                    </div>
